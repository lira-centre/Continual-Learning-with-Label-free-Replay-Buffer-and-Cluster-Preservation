...
def main():
    ...
    results_file = "continual_learning_results_iCaRL.txt"
    ...
    for task_id in range(num_tasks):
        ...
        # Update seen_classes with the current task classes
        ...
        for epoch in range(num_epochs):
            ...
            for batch_features, batch_labels in train_loader:
                ...
                for i, label in enumerate(batch_labels):
                    binary_targets[i, icarl_agent.seen_classes.index(label.item())] = 1
        ...
        for eval_task_id in range(task_id + 1):
            ...
            with torch.no_grad():
                for eval_features, eval_labels in eval_loader:
                    ...
                    all_labels.extend(eval_labels.numpy())
