...
# Add arguments
parser.add_argument("--num_domains", type=int, default=5, help="Number of classes")
...
num_classes = args.num_domains * args.classes_per_task  # Assuming CIFAR-100 dataset
...
train_labels_np = np.where(train_labels_np <= args.classes_per_task - 1, train_labels_np, train_labels_np % args.classes_per_task)
test_labels_np = np.where(test_labels_np <=  args.classes_per_task - 1, test_labels_np, test_labels_np % args.classes_per_task)
